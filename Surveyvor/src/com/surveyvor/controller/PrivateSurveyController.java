...
public class PrivateSurveyController {
	...
	public boolean checkAccess() {
		...
		if (params.get("surveyId") != null && params.get("userId") != null) {
			...
			if (survey != null) {
				...
				if (survey.getParametres().getPrivateSurvey()) {
					...
					if (userControler.isConneted()) {
						...
						if (user == null || user.getMail()
							...
							facesContext.addMessage(null,
									new FacesMessage(FacesMessage.SEVERITY_ERROR,
											"Vous n'�tes pas autoris� d'acc�der � ce sondage par ce lien. "
						...
						facesContext.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
								"Vous n'�tes pas autoris� � acc�der � ce sondage. " + "Veuillez vous connecter.", ""));
						survey = new Survey();
						surveyControler.setSelected(survey);
						allgood = false;
					}
				...
				FacesContext facesContext = FacesContext.getCurrentInstance();
				facesContext.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
						"Nous n'avons pas trouv� le sondage auquel vous essayez d'acc�der. ", ""));
			}
	...
	public boolean checkIfInDiffusion(User user, Survey survey) {
		...
		if (user != null) {
			...
			FacesContext facesContext = FacesContext.getCurrentInstance();
			facesContext.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR,
					"Vous n'�tes pas autoris� � acc�der � ce sondage. " + "Veuillez vous connecter avec le bon compte.",
					""));
		}
		return isIn;
	}
