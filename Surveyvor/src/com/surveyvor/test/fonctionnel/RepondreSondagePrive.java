...
public class RepondreSondagePrive {
  ...
  @Test
  public void testRepondreSondagePrive() throws Exception {
    ...
    driver.findElement(By.xpath("//table[@id='paramForm:visibility']/tbody/tr/td[3]/div/div[2]/span")).click();
    driver.findElement(By.id("paramForm:visibility:1")).click();
    driver.findElement(By.xpath("//li[5]/a/span")).click();
    driver.findElement(By.id("myform:table:1:j_idt39")).click();
